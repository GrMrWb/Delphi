...
def feed_server_with_data_FashionMNIST(val_size, train_batch_size, config, adversarial_clients, CML=False):
    ...
    trainset = datasets.FashionMNIST(config["collection"]["path"]["training"], download=True, train=True, transform=transform_train)
    testset= datasets.FashionMNIST(config["collection"]["path"]["testing"], download=True, train=False, transform=transform_train)
